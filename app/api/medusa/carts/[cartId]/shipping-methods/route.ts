/**
 * Proxy API route for Medusa cart shipping methods
 * POST /api/medusa/carts/[cartId]/shipping-methods - Add shipping method to cart
 */
  ...
  try {
    ...
    if (!response.ok) {
      return NextResponse.json(
        { success: false, error: data.message || 'Failed to add shipping method' },
    ...
    console.error('[API] Error adding shipping method:', error)
    return NextResponse.json(
