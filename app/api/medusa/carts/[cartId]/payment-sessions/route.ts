/**
 * Proxy API route for Medusa cart payment sessions
 * POST /api/medusa/carts/[cartId]/payment-sessions - Initialize payment
 */
...
export async function POST(
  ...
  try {
    ...
    const response = await fetch(`${MEDUSA_API_URL}/store/carts/${cartId}/payment-sessions`, {
      method: 'POST',
